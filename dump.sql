...
INSERT INTO "Ability" VALUES(6,6,'sneak',1);
...
INSERT INTO "Area" VALUES(1,'Dark Woods');
...
INSERT INTO "Attributes" VALUES(5,20,100,100,15,15,15,15,15,15,1,1,0,0,0,0);
INSERT INTO "Attributes" VALUES(6,20,100,100,15,15,15,15,15,15,1,1,0,0,0,0);
...
INSERT INTO "Direction" VALUES(7,'south',4,5);
INSERT INTO "Direction" VALUES(8,'north',5,4);
INSERT INTO "Direction" VALUES(9,'south',5,7);
INSERT INTO "Direction" VALUES(10,'north',6,7);
INSERT INTO "Direction" VALUES(11,'north',7,5);
INSERT INTO "Direction" VALUES(12,'south',7,6);
INSERT INTO "Direction" VALUES(13,'west',5,8);
INSERT INTO "Direction" VALUES(14,'east',8,5);
INSERT INTO "Direction" VALUES(15,'east',5,9);
INSERT INTO "Direction" VALUES(16,'west',9,5);
INSERT INTO "Direction" VALUES(17,'north',2,10);
INSERT INTO "Direction" VALUES(18,'south',10,2);
INSERT INTO "Direction" VALUES(19,'north',10,11);
INSERT INTO "Direction" VALUES(20,'south',11,10);
INSERT INTO "Direction" VALUES(21,'north',11,12);
INSERT INTO "Direction" VALUES(22,'south',12,11);
INSERT INTO "Direction" VALUES(23,'east',4,13);
INSERT INTO "Direction" VALUES(24,'west',13,4);
INSERT INTO "Direction" VALUES(25,'north',13,14);
INSERT INTO "Direction" VALUES(26,'south',14,13);
...
INSERT INTO "Inventory" VALUES(1,0,20,500,250);
...
INSERT INTO "Inventory" VALUES(10,0,100,500,250);
INSERT INTO "Inventory" VALUES(11,0,0,500,250);
INSERT INTO "Inventory" VALUES(12,0,0,500,250);
INSERT INTO "Inventory" VALUES(13,0,0,500,250);
INSERT INTO "Inventory" VALUES(14,0,0,500,250);
INSERT INTO "Inventory" VALUES(15,0,0,500,250);
INSERT INTO "Inventory" VALUES(16,0,0,500,250);
INSERT INTO "Inventory" VALUES(17,0,0,500,250);
INSERT INTO "Inventory" VALUES(18,0,0,500,250);
INSERT INTO "Inventory" VALUES(19,0,0,500,250);
INSERT INTO "Inventory" VALUES(20,0,0,500,250);
INSERT INTO "Inventory" VALUES(21,0,0,500,250);
INSERT INTO "Inventory" VALUES(22,0,0,500,250);
INSERT INTO "Inventory" VALUES(23,0,0,500,250);
INSERT INTO "Inventory" VALUES(24,0,0,500,250);
INSERT INTO "Inventory" VALUES(25,0,0,500,250);
INSERT INTO "Inventory" VALUES(26,0,0,500,250);
CREATE TABLE Item (id INTEGER NOT NULL, inventory_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, look VARCHAR(255) DEFAULT NULL, material VARCHAR(255) NOT NULL, identifiers CLOB NOT NULL, weight NUMERIC(10, 0) NOT NULL, value NUMERIC(10, 0) NOT NULL, position VARCHAR(255) DEFAULT NULL, level INTEGER NOT NULL, vNum VARCHAR(255) NOT NULL, craftedBy_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_BF298A209EEA759 FOREIGN KEY (inventory_id) REFERENCES Inventory (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
INSERT INTO "Item" VALUES(1,3,'a small brass key',NULL,'brass','a:3:{i:0;s:5:"small";i:1;s:5:"brass";i:2;s:3:"key";}',0.1,20,'',1,'9c4b540e-d4b4-4b4f-9a5e-a356a4551e26',NULL);
INSERT INTO "Item" VALUES(2,5,'a loaf of bread',NULL,'food','a:2:{i:0;s:4:"loaf";i:1;s:5:"bread";}',0.2,4,'',1,'e39b41cd-69e5-4ec3-8d0f-3b27677ce22a',NULL);
INSERT INTO "Item" VALUES(3,3,'a copper teapot',NULL,'copper','a:2:{i:0;s:6:"copper";i:1;s:6:"teapot";}',0.5,0,'',1,'bcc89181-b70b-4370-8883-d11006034b33',NULL);
INSERT INTO "Item" VALUES(4,3,'a wooden sword',NULL,'wood','a:2:{i:0;s:6:"wooden";i:1;s:5:"sword";}',4,0,'wielded',1,'ff5c8d1b-6d76-4ffb-85e2-1ed6fad8d4be',NULL);
INSERT INTO "Item" VALUES(5,3,'a wooden mace',NULL,'wood','a:2:{i:0;s:6:"wooden";i:1;s:4:"mace";}',5,0,'wielded',1,'64befce1-aea0-40ef-a394-e3a866650432',NULL);
...
INSERT INTO "Mob" VALUES(6,14,6,25,26,'a grocer',NULL,'standing','a:2:{i:0;s:1:"a";i:1;s:6:"grocer";}','elf',20,100,100,0,'neutral',0,1,0,1483211321,'a:1:{i:0;s:10:"shopkeeper";}',0,0,0,'uninitiated',0,5);
...
INSERT INTO "Room" VALUES(1,9,1,'Arms and Armour','A cramped armory is filled with cheap but sturdy training equipment. A red-hot forge and workshop consume the back half of the already small space. A silhouette of a dwarf can be seen in front of the forge, hammering out new weapons and armor.',0.1,1,0);
...
INSERT INTO "Room" VALUES(5,13,1,'The South Gate','You are engulfed by a mist.',0.1,1,0);
INSERT INTO "Room" VALUES(6,14,1,'A Small Path Leading To Dark Woods','You are engulfed by a mist.',0.1,1,0);
INSERT INTO "Room" VALUES(7,15,1,'Outside The South Gate','You are engulfed by a mist.',0.1,1,0);
INSERT INTO "Room" VALUES(8,16,1,'Wall Road','An impenetrable wall spans high into the sky. Crafted from enormous stone, strong and resilient, the wall has stood the test of time. A cobblestone path leads around the inside perimeter of the wall.',0.1,1,0);
INSERT INTO "Room" VALUES(9,17,1,'Wall Road','You are engulfed by a mist.',0.1,1,0);
INSERT INTO "Room" VALUES(10,18,1,'The Temple Square','An immense square with an equally grand temple to the north.',0.1,1,0);
INSERT INTO "Room" VALUES(11,19,1,'The Temple of Midgaard','An immense square with an equally grand temple to the north.',0.1,1,0);
INSERT INTO "Room" VALUES(12,20,1,'A Sacrifical Pit','An immense square with an equally grand temple to the north.',0.1,1,0);
INSERT INTO "Room" VALUES(13,21,1,'Midgaard Commons Road','A narrow and worn road traverses through a chaotic and busy array of shops and merchants.',0.1,1,0);
INSERT INTO "Room" VALUES(14,22,1,'A Grocery Store','A grocery store is here.',0.1,1,0);
CREATE TABLE migration_versions (version VARCHAR(255) NOT NULL, PRIMARY KEY(version));
INSERT INTO "migration_versions" VALUES('20170101064958');
